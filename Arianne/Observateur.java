                ...
                if(clique<0 && (nbrE==1 || nbrS==1)){
                    if(clique==-1 && nbrE == 1){
                        if(gx<taille*40 && gy<taille*40){
                            ...
                            Decode decode = new Decode(PositionXROUGE,PositionYROUGE);  
                    ...
                    if(clique==-2 && nbrS == 1 ){
                        if(gx<taille*40 && gy<taille*40){
                            ...
                            Decode decode = new Decode(PositionXVERT,PositionYVERT);
                    ...
                    if(gx<taille*40 && gy<taille*40){
                        ...
                        Decode decode = new Decode(PositionXNOIR,PositionYNOIR);
